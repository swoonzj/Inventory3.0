...
namespace Inventory_3._0
{
    class DBAccess
    {
        ...
        static SqlConnection homeConnection = new SqlConnection(Properties.Settings.Default.HomeInventoryConnectionString); // Homenew SqlConnection(Properties.Settings.Default.CgSimpConnectionString); // SIMP
        static SqlConnection simpConnection = new SqlConnection(Properties.Settings.Default.CgSimpConnectionString); // Home
        static SqlConnection traderJoeConnection = new SqlConnection(Properties.Settings.Default.SQLServerConnectionString2); // Home
